...
export const metadata: Metadata = {
  title: "Buy copier printer parts & toner Slough Berkshire",
  description:
    "Buy copier printer parts & toner in Slough, Berkshire with BuySupply dealer services. We buy and sell photocopiers, printers, toners, ink, and consumables for local businesses.",
};

export default function DealerSloughBerkshirePage() {
  return (
    <LocationHomePage
      heroTitle="BUYSUPPLY"
