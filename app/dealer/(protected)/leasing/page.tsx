...
export default function DealerLeasingPage() {
  return (
    <DealerSectionPageLayout title="LEASING" showFeaturedProducts>
      ...
      <h3 className="text-xl font-semibold text-white">Our Service</h3>
      ...
      <h2 className="text-2xl font-semibold mb-2 text-white">Become a Partner</h2>
      <p>
      If you would like to explore how Buysupply can support your business, please get in touch with our team.
      </p>
