...
export default function DealerPhotocopierRentalPage() {
  return (
    <DealerSectionPageLayout title="PHOTOCOPIER RENTAL (NO LEASE)" showFeaturedProducts>
      <h2 className="text-2xl font-semibold mb-4 text-white">
        PHOTOCOPIER RENTAL SLOUGH & LONDON â€“ NO LEASE
      </h2>

      <p className="mb-4">
        <strong>Rent a Photocopier from Â£85/Month â€“ Fully Serviced, No Contracts</strong>
      </p>
      ...
      <ul className="list-disc list-inside space-y-2 mb-6">
        <li>Photocopier rental from just Â£85 per month</li>
