...
export default function DealerExportSalesPage() {
  return (
    <DealerSectionPageLayout title="EXPORT SALES" showFeaturedProducts>
      ...
      <h3 className="text-xl font-semibold text-white">Fast Delivery to UK Shipping Hubs</h3>
      <p>
      ...
      <h3 className="text-xl font-semibold text-white">Large & Constantly Changing Stock</h3>
      <ul className="list-disc list-inside space-y-2">
        <li>Canon</li>
        <li>Xerox</li>
        <li>Ricoh</li>
      ...
      <h3 className="text-xl font-semibold text-white">Built for Long-Term Supply</h3>
      <p>
      ...
      <h3 className="text-xl font-semibold text-white">Work With Us</h3>
      <ul className="list-disc list-inside space-y-2">
