...
export const metadata: Metadata = {
  title: "Buy copier printer parts & toner Ascot Berkshire",
  description:
    "Buy copier printer parts & toner in Ascot, Berkshire with BuySupply dealer services. We buy and sell photocopiers, printers, toners, ink, and consumables for local businesses.",
};

export default function DealerAscotBerkshirePage() {
  return (
    <LocationHomePage
      heroTitle="BUYSUPPLY"
