...
export const metadata: Metadata = {
  title: "Buy copier printer parts & toner Reading Berkshire",
  description:
    "Buy copier printer parts & toner in Reading, Berkshire with BuySupply dealer services. We buy and sell photocopiers, printers, toners, ink, and consumables for local businesses.",
};

export default function DealerReadingBerkshirePage() {
  return (
    <LocationHomePage
      heroTitle="BUYSUPPLY"
