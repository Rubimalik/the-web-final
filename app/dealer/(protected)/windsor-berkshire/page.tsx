...
export const metadata: Metadata = {
  title: "Buy copier printer parts & toner Windsor Berkshire",
  description:
    "Buy copier printer parts & toner in Windsor, Berkshire with BuySupply dealer services. We buy and sell photocopiers, printers, toners, ink, and consumables for local businesses.",
};

export default function DealerWindsorBerkshirePage() {
  return (
    <LocationHomePage
      heroTitle="BUYSUPPLY"
